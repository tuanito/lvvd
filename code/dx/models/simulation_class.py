...
class simulation_class(object):
    ...
    def generate_time_grid(self):
        ...
        # translate deprecated pandas offset aliases (M -> ME etc.)
        alias = {'M': 'ME', 'Q': 'QE', 'A': 'YE', 'Y': 'YE',
                 'SM': 'SME', 'BM': 'BME', 'CBM': 'CBME',
                 'MS': 'MS', 'QS': 'QS', 'YS': 'YS', 'AS': 'YS'}
        freq = alias.get(self.frequency, self.frequency)
